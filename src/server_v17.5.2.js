...
Analyse une photo prise par un utilisateur.

La photo peut représenter :
- une peinture, sculpture, œuvre d'art, cartel de musée ;
- une église, monument, bâtiment, rue, ville ;
- un avion, train, voiture, objet technique ;
- un paysage, jardin, parc, montagne, mer ;
- un restaurant, plat, intérieur, scène quotidienne ;
- ou tout autre objet.

Tu dois identifier d'abord le TYPE / OBJET PRINCIPAL, puis donner les informations utiles. Ne juge jamais si l'objet est une œuvre d'art ou non : tu produis une fiche normée pour toute photo.
...
- confidence doit être un nombre entre 0 et 1.
- keywords doit être un tableau JSON.
- visible_elements doit être un tableau JSON.
