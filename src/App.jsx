...
const VERSION = {
  ...
  descriptif: "Renommage : attentes bornées, modales interruptibles, accueil figé à définition unique",
  date: "2026-09-10",
  build: 5,
};
...
function listerEtatsHorsAccueil() {
  return [
    ...
    { nom: "recherches", actif: modeRecherches, eteindre: () => setModeRecherches(false) },
