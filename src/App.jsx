// PhotoCartel v42.0.2 — correction responsive PWA de la page d’accueil.
...
const validerNouvelleVisite = async () => {
  ...
  const baseStyles = {
    ...
    accueilInformations: {
      ...
      height: "100%",
      boxSizing: "border-box",
      padding: "84px 10px 10px 15px",
      background: "#fff8eb",
      display: "grid",
      gridTemplateRows: "repeat(3, minmax(0, 1fr)) auto",
      textAlign: "left",
    },
    accueilPhoto: {
      width: "100%",
    ...
    <div
      style={{
        ...
        ...((listeDernieresVisitesOuverte || visiteResumeSelectionnee)
          ? { paddingBottom: listeDernieresVisitesOuverte ? "250px" : "150px" }
          : {}),
      }}
    >
      <style>{`
