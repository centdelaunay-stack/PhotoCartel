...
const VERSION = {
  numero: "v31.0",
  descriptif: "multi-visite PWA et ville mémorisée par voyage",
  date: "2026-07-10",
  build: 1,
};
...
// PhotoCartel v31.0 — multi-visite PWA.
// Objectif : enchaîner plusieurs visites dans un même voyage, conserver leurs fenêtres de rangement
// et mémoriser la dernière ville structurée utilisée pour chaque voyage.
...
async function handlePhotosPrises(event) {
  ...
  async function creerVisiteRapide() {
    ...
    const cheminParentTampon = cheminVilleMetier(voyage, villeCible);
