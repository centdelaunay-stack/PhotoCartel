// PhotoCartel v47.3 — cache de retour Grille conservé et suppression physique des photos de visite.
...
const VERSION = {
  ...
  descriptif: "Cache Grille conservé et suppression des photos de visite",
  date: "2026-07-27",
  build: 3,
};
  ...
  function BarreGalerieVisite({ fichePhoto = false }) {
    const actions = fichePhoto
      ? [
          ...
          { icone: "🗑️", texte: "Supprimer", action: () => { setErreurSuppressionPhotoVisite(""); setConfirmationSuppressionPhotoVisite(true); }, danger: true },
        ]
      : [
          { icone: "🏠", texte: "Accueil", action: retourAccueil },
  ...
  return (
    ...
    >
      ...
      {confirmationSuppressionPhotoVisite && (
        <div
          style={{ ...styles.modalFond, zIndex: 10030 }}
          role="presentation"
        ...
        >
          ...
          >
            ...
            >
              {suppressionPhotoVisiteEnCours ? "Suppression…" : "Supprimer"}
            </button>
            <button
              type="button"
