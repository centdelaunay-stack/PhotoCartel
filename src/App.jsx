...
const VERSION = {
  numero: "v28.3.1",
  descriptif: "suppression pop-ups confirmation succès",
  date: "2026-07-08",
  build: 10,
};
...
// PhotoCartel v28.3.1 — suppression des pop-ups de confirmation de succès, moteur métier conservé.
...
const afficherMessageDiscretArborescence = (message, duree = 4500) => {
  // v28.3.1 : confirmation de succès non bloquante.
  // Plus de alert() après création réussie d'un voyage ou d'une visite.
...
async function creerDossiersNouvelleVisiteAndroid({ voyageNom, villeNom, visiteNom, typeVisiteNom }) {
  ...
  setMessageArborescenceAndroid(
    "Création Android : PhotoCartel réutilise l'autorisation existante. Sinon, sélectionne le dossier PhotoCartel dans DCIM une seule fois."
  );
