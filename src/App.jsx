...
const VERSION = {
  numero: "v32.3 DEV",
  descriptif: "nouveau layout de la fiche résultat",
  date: "2026-07-11",
  build: 1,
};
...
// PhotoCartel v32.3 DEV — nouveau layout de la fiche résultat.
...
const validerNouvelleVisite = async () => {
  ...
  function BarreActionsFicheResultat() {
    // v32.3 DEV : barre contextuelle encore non connectée ; validation du nouveau layout.
