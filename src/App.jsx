// PhotoCartel v42.5.2 — drapeaux étendus et fenêtre Recherches.
...
const VERSION = {
  ...
  descriptif: "Galerie des visites — PC et PWA alignés",
  date: "2026-07-26",
  build: 2,
};
...
// v42.5.2 — déduction volontairement déterministe du drapeau depuis le nom du voyage.
// Aucun appel IA, aucun service externe et aucun nouveau champ métier.
const DRAPEAUX_VOYAGE_PAR_MOTS_CLES = [
  { drapeau: "🇰🇵", mots: ["coree du nord", "north korea"] },
  { drapeau: "🇰🇷", mots: ["coree du sud", "coree", "south korea", "korea"] },
  { drapeau: "🇯🇵", mots: ["japon", "japan"] },
  { drapeau: "🇨🇳", mots: ["chine", "china"] },
  { drapeau: "🇹🇼", mots: ["taiwan"] },
  { drapeau: "🇭🇰", mots: ["hong kong"] },
  { drapeau: "🇹🇭", mots: ["thailande", "thailand"] },
  { drapeau: "🇻🇳", mots: ["vietnam"] },
  { drapeau: "🇰🇭", mots: ["cambodge", "cambodia"] },
  { drapeau: "🇱🇦", mots: ["laos"] },
  { drapeau: "🇮🇩", mots: ["indonesie", "indonesia", "bali"] },
  { drapeau: "🇲🇾", mots: ["malaisie", "malaysia"] },
  { drapeau: "🇸🇬", mots: ["singapour", "singapore"] },
  { drapeau: "🇵🇭", mots: ["philippines", "philippine"] },
  { drapeau: "🇮🇳", mots: ["inde", "india"] },
  { drapeau: "🇳🇵", mots: ["nepal"] },
  { drapeau: "🇱🇰", mots: ["sri lanka"] },
  { drapeau: "🇦🇺", mots: ["australie", "australia"] },
  { drapeau: "🇳🇿", mots: ["nouvelle zelande", "new zealand"] },
  { drapeau: "🇫🇷", mots: ["france"] },
  { drapeau: "🇪🇸", mots: ["espagne", "spain"] },
  { drapeau: "🇵🇹", mots: ["portugal"] },
  { drapeau: "🇮🇹", mots: ["italie", "italy"] },
  { drapeau: "🇩🇪", mots: ["allemagne", "germany"] },
  { drapeau: "🇧🇪", mots: ["belgique", "belgium"] },
  { drapeau: "🇳🇱", mots: ["pays bas", "netherlands", "hollande"] },
  { drapeau: "🇬🇧", mots: ["royaume uni", "angleterre", "ecosse", "pays de galles", "great britain", "united kingdom", "england", "scotland"] },
  { drapeau: "🇮🇪", mots: ["irlande", "ireland"] },
  { drapeau: "🇨🇭", mots: ["suisse", "switzerland"] },
  { drapeau: "🇦🇹", mots: ["autriche", "austria"] },
  { drapeau: "🇬🇷", mots: ["grece", "greece"] },
  { drapeau: "🇭🇷", mots: ["croatie", "croatia"] },
  { drapeau: "🇸🇮", mots: ["slovenie", "slovenia"] },
  { drapeau: "🇨🇿", mots: ["republique tcheque", "tchequie", "czechia"] },
  { drapeau: "🇵🇱", mots: ["pologne", "poland"] },
  { drapeau: "🇭🇺", mots: ["hongrie", "hungary"] },
  { drapeau: "🇷🇴", mots: ["roumanie", "romania"] },
  { drapeau: "🇧🇬", mots: ["bulgarie", "bulgaria"] },
  { drapeau: "🇩🇰", mots: ["danemark", "denmark"] },
  { drapeau: "🇸🇪", mots: ["suede", "sweden"] },
  { drapeau: "🇳🇴", mots: ["norvege", "norway"] },
  { drapeau: "🇫🇮", mots: ["finlande", "finland"] },
  { drapeau: "🇪🇪", mots: ["estonie", "estonia"] },
  { drapeau: "🇱🇹", mots: ["lituanie", "lithuania"] },
  { drapeau: "🇮🇸", mots: ["islande", "iceland"] },
  { drapeau: "🇹🇷", mots: ["turquie", "turkey"] },
  { drapeau: "🇲🇦", mots: ["maroc", "morocco"] },
  { drapeau: "🇹🇳", mots: ["tunisie", "tunisia"] },
  { drapeau: "🇪🇬", mots: ["egypte", "egypt"] },
  { drapeau: "🇿🇦", mots: ["afrique du sud", "south africa"] },
  { drapeau: "🇺🇸", mots: ["etats unis", "usa", "united states"] },
  { drapeau: "🇨🇦", mots: ["canada"] },
  { drapeau: "🇲🇽", mots: ["mexique", "mexico"] },
  { drapeau: "🇧🇷", mots: ["bresil", "brazil"] },
  { drapeau: "🇦🇷", mots: ["argentine", "argentina"] },
  { drapeau: "🇨🇱", mots: ["chili", "chile"] },
  { drapeau: "🇵🇪", mots: ["perou", "peru"] },
];

function normaliserNomVoyagePourDrapeau(valeur = "") {
...
function drapeauPourNomVoyage(nomVoyage = "") {
  const nomNormalise = normaliserNomVoyagePourDrapeau(nomVoyage);
  if (!nomNormalise) return "🇪🇺";

  const correspondance = DRAPEAUX_VOYAGE_PAR_MOTS_CLES.find(({ mots }) =>
    mots.some((mot) => nomNormalise.includes(normaliserNomVoyagePourDrapeau(mot)))
  );

  return correspondance?.drapeau || "🇪🇺";
}

// Sous Windows, les drapeaux Unicode peuvent être affichés comme les lettres FR, IT, EU, etc.
// L'image garantit un véritable drapeau dans Chrome, Android et la PWA.
function codePaysDepuisDrapeau(drapeau = "🇪🇺") {
  const points = Array.from(String(drapeau));
  if (points.length !== 2) return "eu";

  const lettres = points.map((caractere) => {
  ...
  return lettres.join("") || "eu";
}

function urlImageDrapeauPourNomVoyage(nomVoyage = "") {
  const codePays = codePaysDepuisDrapeau(drapeauPourNomVoyage(nomVoyage));
  return `https://flagcdn.com/24x18/${codePays}.png`;
}
...
const CLE_CACHE_VISITES_PHYSIQUES = "photoCartelCacheVisitesPhysiques_v45_2";
const TAILLE_LOT_GALERIE_VISITE = 60;
...
const [nombrePhotosGalerieAffichees, setNombrePhotosGalerieAffichees] = useState(TAILLE_LOT_GALERIE_VISITE);
...
const afficherMessageDiscretArborescence = (message, duree = 5000) => {
  ...
  async function lireVisitesPhysiquesAndroid({ autoriserSelection = false } = {}) {
    ...
    // v45.1 : l'infrastructure PWA est créée intelligemment dès que la racine est autorisée.
  ...
  async function resoudreHandleVisiteAndroid(visite) {
  ...
  async function listerPhotosVisiteAndroid(visite) {
  ...
  useEffect(() => {
    const cache = lireCacheVisitesPhysiques();
    if (cache.length) setVisitesPhysiques(cache);

    // v45.2 : le cache est rendu immédiatement. La vérification physique est différée
    // pour ne plus monopoliser le téléphone pendant son premier affichage.
    const lancerActualisation = () => {
      actualiserVisitesPhysiques({ autoriserSelection: false, silencieux: cache.length > 0 });
    };
    let identifiant = null;
    if (typeof window !== "undefined" && "requestIdleCallback" in window) {
      identifiant = window.requestIdleCallback(lancerActualisation, { timeout: 2500 });
      return () => window.cancelIdleCallback?.(identifiant);
    }
    identifiant = setTimeout(lancerActualisation, cache.length ? 1200 : 50);
...
const validerNouvelleVisite = async () => {
          ...
          <div className="photocartel-accueil-informations" style={styles.accueilInformations}>
            <div className="photocartel-accueil-voyage-titre" style={styles.accueilVoyageTitreLigne}>
              <div style={styles.accueilVoyageTexte}>
                ...
                >
                  <img
                    src={urlImageDrapeauPourNomVoyage(voyage)}
                    alt=""
                    aria-hidden="true"
                    width="24"
                    height="18"
                    style={{
                      ...
                      objectFit: "cover",
                      borderRadius: "2px",
                      boxShadow: "0 0 0 1px rgba(90, 65, 30, 0.12)",
                    }}
                  />
  ...
  async function ouvrirGalerieVisiteMaquette(visite) {
    ...
    setIndexPhotoGalerieVisite(0);
    setNombrePhotosGalerieAffichees(TAILLE_LOT_GALERIE_VISITE);
    setModePhotoGalerieVisite(false);
    setPhotosGalerieVisite([]);
    setErreurGalerieVisite("");
    ...
    try {
      let photos = [];
      if (estAndroid()) {
        photos = await listerPhotosVisiteAndroid(visite);
      } else {
        const cheminVisite = String(visite.chemin || "").trim();
        if (!cheminVisite) {
          throw new Error("Le chemin physique de cette visite n’est pas disponible.");
        }
        const lirePage = async (offset = 0) => {
          const response = await fetch(
            `${API_BASE}/api/photos-visite?chemin=${encodeURIComponent(cheminVisite)}&offset=${offset}&limit=120`
          );
          const data = await lireReponseJsonPhotoCartel(
            response,
            "Lecture des photos de la visite"
          );
          if (!response.ok || data.success === false) {
            throw new Error(data.error || "Impossible de lire les photos de cette visite.");
          }
          return data;
        };

        const premierePage = await lirePage(0);
        photos = Array.isArray(premierePage.photos) ? premierePage.photos : [];
        setPhotosGalerieVisite(photos);
        setIndexPhotoGalerieVisite(0);
        setChargementGalerieVisite(false);

        // v45.2 : la grille est utilisable dès la première page ; le reste arrive en arrière-plan.
        let offsetSuivant = premierePage.suivantOffset;
        while (offsetSuivant !== null && offsetSuivant !== undefined) {
          const page = await lirePage(offsetSuivant);
      ...
      setPhotosGalerieVisite([]);
      setErreurGalerieVisite(
        error?.message || "Impossible de lire les photos de cette visite."
      );
    } finally {
      setChargementGalerieVisite(false);
    }
  ...
  function fermerGalerieVisiteMaquette() {
    for (const url of urlsObjetGalerieVisiteRef.current) URL.revokeObjectURL(url);
    urlsObjetGalerieVisiteRef.current = [];
    setModePhotoGalerieVisite(false);
    setModeGalerieVisite(false);
    setVisiteGalerieMaquette(null);
    setPhotosGalerieVisite([]);
  ...
  function photoGalerieVisitePrecedente() {
    const total = photosGalerieVisite.length;
    if (!total) return;
  ...
  function BarreGalerieVisite({ fichePhoto = false }) {
    const actions = fichePhoto
      ? [
          ...
          { icone: "🖼️", texte: "Galerie", action: () => setModePhotoGalerieVisite(false) },
          { icone: "⭐", texte: "Favoris", action: () => {} },
          { icone: "📤", texte: "Partager", action: () => {} },
          { icone: "🗑️", texte: "Supprimer", action: () => {}, danger: true },
        ]
      : [
          { icone: "🏠", texte: "Accueil", action: retourAccueil },
  ...
  function ImageGalerieVisite({ photo, miniature = false, alt = "", style }) {
    const [source, setSource] = useState(() => miniature ? urlMiniatureGalerieVisite(photo) : urlPhotoGalerieVisite(photo));
      ...
      const charger = async () => {
        if (photo?.handleAndroid?.kind === "file") {
          try {
            ...
            urlsObjetGalerieVisiteRef.current.push(urlObjet);
            setSource(urlObjet);
          } catch (error) {
            console.warn("Chargement différé d'une photo impossible :", error);
          }
        } else {
    ...
    return <img src={source} alt={alt} loading={miniature ? "lazy" : "eager"} decoding="async" style={style} />;
  }
  ...
  function EnteteGalerieVisite({ fichePhoto = false }) {
    ...
    return (
      <header style={styles.galerieVisiteEntete}>
        <button
          type="button"
          onClick={() => fichePhoto ? setModePhotoGalerieVisite(false) : fermerGalerieVisiteMaquette()}
      ...
      return (
        <section style={styles.galerieVisiteEcran} aria-label="Fiche photo de la Galerie d’une visite">
          ...
          >
            ...
            />
            <span style={styles.galerieVisiteCompteurPhoto}>{indexPhotoGalerieVisite + 1} / {photosGalerieVisite.length}</span>
          ...
          <div
            ...
            onScroll={(event) => {
              ...
              if (element.scrollTop + element.clientHeight >= element.scrollHeight - 500) {
                setNombrePhotosGalerieAffichees((ancien) =>
                  Math.min(photosGalerieVisite.length, ancien + TAILLE_LOT_GALERIE_VISITE)
                );
              }
            }}
          >
            {photosGalerieVisite.slice(0, nombrePhotosGalerieAffichees).map((photo, index) => (
              <button
                key={photo.id || `${photo.cheminRelatif}-${index}`}
                type="button"
                onClick={() => ouvrirPhotoGalerieVisiteMaquette(index)}
                style={styles.galerieVisiteVignette}
              ...
              >
                <ImageGalerieVisite
                  ...
                  miniature
                  alt=""
                  style={styles.galerieVisiteVignetteImage}
                />
      ...
      {modeRecherches && (
        <div style={styles.modalOverlay}>
          <div style={styles.modal}>
            ...
            <BoutonMenuPopup icone="🔎" titre="Recherche par critères" onClick={() => afficherMessageSousBouton("recherche-criteres")} />
            <MessageSousBouton cible="recherche-criteres" />
            <BoutonMenuPopup icone="💬" titre="Recherche par langage naturel" onClick={() => afficherMessageSousBouton("recherche-langage-naturel")} />
            <MessageSousBouton cible="recherche-langage-naturel" />
            <BoutonMenuPopup icone="🧠" titre="Recherche intelligente" onClick={() => afficherMessageSousBouton("recherche-intelligente")} />
            <MessageSousBouton cible="recherche-intelligente" />
            <BoutonMenuPopup titre="Fermer" secondaire onClick={() => {
              setModeRecherches(false);
              setMessageMenuAccueil("");
              setCibleMessageMenuAccueil("");
      ...
      {modeRenommerAccueil && (
        <div style={styles.modalOverlay}>
          <div style={styles.modal}>
            ...
            <BoutonMenuPopup icone="🖼️" titre="Renommer une photo" onClick={() => afficherMessageSousBouton("renommer-photo")} />
            <MessageSousBouton cible="renommer-photo" />
            <BoutonMenuPopup icone="📁" titre="Renommer un dossier" onClick={() => afficherMessageSousBouton("renommer-dossier")} />
            <MessageSousBouton cible="renommer-dossier" />
            <BoutonMenuPopup titre="Fermer" secondaire onClick={() => {
              setModeRenommerAccueil(false);
              setMessageMenuAccueil("");
              setCibleMessageMenuAccueil("");
