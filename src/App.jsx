// PhotoCartel v42.0.13 — correction PWA du renommage de visite avec copie typée et collisions sans perte.
...
const afficherMessageDiscretArborescence = (message, duree = 5000) => {
  ...
  async function copierDossierAndroidRecursive(source, destination, ancienNom, nouveauNom) {
    // v42.0.13 : toutes les créations passent par les helpers typés.
