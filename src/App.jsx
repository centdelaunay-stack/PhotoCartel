// PhotoCartel v42.0.9 — copie Android sécurisée lors du renommage d’une visite ; parcours d’autorisation clarifié.
...
const VERSION_PHOTOCARTEL = "v42.0.9";

const VERSION = {
  numero: VERSION_PHOTOCARTEL,
  descriptif: "Accueil responsive et dernières visites",
  date: "2026-07-20",
  build: 2,
};
...
async function obtenirDossierRacinePhotoCartelAndroid({
  ...
  // v42.0.9 : l’identifiant reste volontairement stable afin que Chrome
