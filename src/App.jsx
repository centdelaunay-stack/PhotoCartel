// PhotoCartel v42.0.3 — compactage responsive PWA conforme à la cible du bloc d’accueil.
...
const afficherMessageDiscretArborescence = (message, duree = 5000) => {
  ...
  async function lireVisitesPhysiquesAndroid({ autoriserSelection = false } = {}) {
    ...
    const racine = resultatRacine?.dossierPhotoCartel;
    if (!racine) throw new Error("Accès au dossier PhotoCartel requis pour lire les visites.");
    ...
    <div
      style={{
        ...
        ...((listeDernieresVisitesOuverte || visiteResumeSelectionnee)
          ? { paddingBottom: listeDernieresVisitesOuverte ? "110px" : "90px" }
          : {}),
      }}
    >
      <style>{`
      ...
      >
        {resultatClassification && !dashboardRenommage ? (
          ...
          <>
            ...
            <section className="photocartel-dernieres-visites" style={styles.dernieresVisitesAccueil}>
              <div style={styles.dernieresVisitesLabel}>Dernières visites</div>
              <button
                type="button"
                onClick={async () => {
                  const prochaineOuverture = !listeDernieresVisitesOuverte;
                  setListeDernieresVisitesOuverte(prochaineOuverture);
                  if (prochaineOuverture) {
                    await actualiserVisitesPhysiques({ autoriserSelection: estAndroid() });
                    window.setTimeout(() => {
              ...
              {listeDernieresVisitesOuverte && (
                <div id="liste-dernieres-visites-rangees" className="photocartel-liste-dernieres-visites" style={styles.dernieresVisitesListe}>
                  ...
                  {lectureVisitesPhysiquesEnCours ? (
                    ...
                    <div style={styles.dernieresVisitesVide}>⚠️ {erreurLectureVisitesPhysiques}</div>
