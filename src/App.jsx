...
const VERSION = {
  numero: "v32.2 DEV",
  descriptif: "maquette UI de la fiche résultat",
  date: "2026-07-11",
  build: 1,
};
...
// PhotoCartel v32.2 DEV — maquette UI de la fiche résultat.
// Objectif : rendre l’entrée d’analyse disponible depuis tous les écrans,
// interrompre le contexte courant et ouvrir systématiquement « Sélectionner une action ».
...
const validerNouvelleVisite = async () => {
  ...
  const styles = {
    ...
    barreActionsFiche: {
      ...
      borderBottom: `1px solid ${themePhotoCartel.bordureOr}`,
      boxShadow: "0 -10px 28px rgba(91,67,38,0.20)",
      fontFamily: themePhotoCartel.font,
    },
    barreActionsFicheBouton: {
  ...
  function BarreActionsFicheResultat() {
    // v32.2 DEV : maquette UI uniquement.
    // Les quatre actions sont volontairement non connectées pour valider d'abord l'ergonomie.
    const actions = [
      { icone: "🤖", texte: "Lancer l'analyse IA" },
      { icone: "💾", texte: "Enregistrer l'analyse" },
      { icone: "📷", texte: "Reprendre une photo" },
      { icone: "✕", texte: "Fermer sans enregistrer" },
    ];

    return (
      <nav
        style={styles.barreActionsFiche}
        aria-label="Actions propres à la fiche résultat"
      >
        {actions.map((action) => (
          <button
            key={action.texte}
            type="button"
            onClick={() => {}}
            style={styles.barreActionsFicheBouton}
            aria-label={`${action.texte} — maquette non connectée`}
          >
  ...
  return (
    <div style={styles.page}>
      ...
      {(modeAnalysePhoto || analysePhotoSessionActiveRef.current) && (
        <div style={{ ...styles.analyseEcran, paddingBottom: "176px" }}>
          <main style={{ ...styles.analyseTelephone, paddingBottom: "164px" }}>
            ...
            {dateHeurePhotoAnalyse && (
              <div style={styles.dateHeurePhotoCarte}>
                <div style={styles.dateHeurePhotoLabel}>📅 Photo</div>
