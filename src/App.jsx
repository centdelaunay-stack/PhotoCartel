...
const VERSION = {
  numero: "v38.3",
  descriptif: "Autorisation racine PhotoCartel",
  date: "2026-07-16",
  build: 1,
};
...
// PhotoCartel v38.3 — la création d’une visite réactive directement l’autorisation du dossier racine PhotoCartel et ne réutilise plus un sous-dossier invalide.
...
const ouvrirFenetreCreationVisite = (contexte = "nouvelle") => {
  ...
  // v38.3 : aucun type n’est présélectionné lors de l’ouverture.
...
async function obtenirDossierRacinePhotoCartelAndroid({
  ...
  // v38.3 : un nouvel identifiant de sélecteur neutralise l’ancien emplacement
...
async function creerDossiersNouvelleVisiteAndroid({ voyageNom, villeNom, visiteNom, typeVisiteNom }) {
  ...
  // v38.3 : cette fonction est appelée directement depuis le clic « Créer la visite ».
                ...
                {listeTypesVisiteOuverte && (
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: "0 14px 30px rgba(34, 26, 16, 0.16)",
                    }}
                  >
                    <div
                      style={{
                    ...
                    {[
                      ...
                      <button
                        ...
                        type="button"
                        role="option"
                        aria-selected={typeNouvelleVisite === type}
                        onClick={() => {
                          setTypeNouvelleVisite(type);
                          setListeTypesVisiteOuverte(false);
                        }}
                        style={{
                          ...
                          background: "transparent",
                          display: "grid",
                          gridTemplateColumns: "24px 1fr 22px",
                          alignItems: "center",
                          gap: "5px",
                          color: "#24211e",
                          fontFamily: "inherit",
                      ...
                      >
                        <span aria-hidden="true" style={{ textAlign: "center", fontSize: "15px" }}>
                          {icone}
                        </span>
                        <span>{type}</span>
                        <span
        ...
        {resultatClassification && !dashboardRenommage ? (
          ...
          <>
            ...
            <section style={styles.dernieresVisitesAccueil}>
              ...
              >
                <option value="">Sélectionner une visite récente rangée</option>
              </select>
            </section>
