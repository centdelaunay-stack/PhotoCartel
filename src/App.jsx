...
const VERSION = {
  numero: "v34.5",
  descriptif: "autorisations et synchronisation JSON",
  date: "2026-07-13",
  build: 5,
};
...
// PhotoCartel v34.5 — autorisations réutilisées et synchronisation complète des champs édités dans le JSON.
...
async function choisirPrendrePhotoPourAnalyse() {
  // v34.5 : aucun accès au dossier n'est demandé avant l'ouverture de l'appareil photo.
...
async function choisirFichierPourAnalyse() {
  // v34.5 : le sélecteur de fichier s'ouvre immédiatement, sans demande d'accès au dossier.
...
async function enregistrerPhotoAAnalyserAndroid(fichier, timestampInitial) {
  // v34.5 : réutilise silencieusement le handle déjà autorisé. Si ce handle n'est plus
  // utilisable, le sélecteur/permission n'apparaît qu'ici, après le choix réel d'une photo.
  const resultatRacineAndroid = await obtenirDossierRacinePhotoCartelAndroid({
    ouvrirSelecteurSiNecessaire: true,
...
async function lancerAnalysePhotoIA() {
  ...
  // v34.5 : aucune nouvelle demande d'autorisation au lancement de l'IA.
...
function synchroniserAnalysePourSauvegarde(analyseSource) {
  // v34.5 : la fiche patrimoniale est la source éditable. Avant toute écriture,
