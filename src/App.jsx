...
const VERSION = {
  numero: "v28.2.6",
  descriptif: "dossiers métier - sous-dossiers visite PC et Android",
  date: "2026-07-07",
  build: 6,
};
...
// PhotoCartel v28.2.6 — dossiers métier : création réelle Android de la visite.
...
async function creerDossiersNouvelleVisiteAndroid({ voyageNom, villeNom, visiteNom, typeVisiteNom }) {
  // v28.2.6 : création réelle sur Android dans DCIM/PhotoCartel/Voyages/<Voyage>/<Ville>/<Visite>.
  ...
  const dossierDcim = await window.showDirectoryPicker({
    id: "photocartel-dcim-v28-2-6-visite",
    mode: "readwrite",
    startIn: "pictures",
  });
...
const validerNouvelleVisite = async () => {
  // v28.2.6 : création de la visite métier.
