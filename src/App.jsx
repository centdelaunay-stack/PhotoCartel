...
const VERSION = {
  numero: "v37.8",
  descriptif: "accueil : bloc supérieur finalisé",
  date: "2026-07-15",
  build: 1,
};
...
// PhotoCartel v37.8 — bloc supérieur finalisé conformément à la maquette validée ; connexions métier inchangées.
              ...
              <div style={styles.accueilVoyageTexte}>
                ...
                <div
                  style={{
                    ...
                    fontSize:
                      String(voyage || "").length > 30
                        ? "14px"
                        : String(voyage || "").length > 20
                          ? "16px"
                          : "19px",
                  }}
                >
