...
// PhotoCartel v27.3.1-integration-visite — habillage visuel global PhotoCartel. Moteurs conservés.
// Moteurs, endpoints et règles métier conservés.

function App() {
  console.log("APP PRINCIPALE - PhotoCartel v27.3.1-integration-visite parcours-visite-separe cloud-ready");
  ...
  function BarreSuperieurePhotoCartel() {
    return (
      <header style={styles.barreSuperieure} aria-label="En-tête PhotoCartel">
        ...
        <span style={styles.barreSuperieureVersion}>v27.3.1</span>
