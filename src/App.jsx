// PhotoCartel v42.0.7 — correction ciblée : Dernières visites n’ouvre jamais le sélecteur Android ; cache v42.0.5 conservé.
...
const VERSION_PHOTOCARTEL = "v42.0.7";
...
const afficherMessageDiscretArborescence = (message, duree = 5000) => {
  ...
  async function actualiserVisitesPhysiques({ autoriserSelection = false } = {}) {
    try {
      ...
      // v42.0.7 : une erreur de synchronisation ne détruit jamais la liste
