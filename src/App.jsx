...
const VERSION = {
  numero: "v42",
  descriptif: "Le disque est la source de vérité",
  date: "2026-07-20",
  build: 1,
};
...
function App() {
  ...
  async function verifierServeurModificationVisite() {
    ...
    if (String(informations.version || "") !== "v42") {
      throw new Error(
        `Le serveur actif annonce ${informations.version || "une version inconnue"}, pas v42. ` +
