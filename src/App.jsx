...
const VERSION_NUMERO = "v24";
const VERSION_DESCRIPTIF = "création dossier en cours dans DCIM";
const VERSION_COMPLETE = `${VERSION_NUMERO} - ${VERSION_DESCRIPTIF}`;

// PhotoCartel ${VERSION_COMPLETE} — test dossier tampon DCIM/EN_COURS_PhotoCartel. Moteurs conservés.
