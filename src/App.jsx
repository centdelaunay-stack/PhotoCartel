// PhotoCartel v45.1 — alignement PC/PWA des visites physiques et optimisation des galeries.
...
const CLE_CACHE_VISITES_PHYSIQUES = "photoCartelCacheVisitesPhysiques_v45_1";
  ...
  async function listerPhotosVisiteAndroid(visite) {
    ...
    const parcourir = async (dossier, prefixe = "") => {
      ...
      for (const [nom, handle] of entrees) {
        ...
        urlsObjetGalerieVisiteRef.current.push(url);
        photos.push({
          id: `${relatif}-${fichier.lastModified}-${fichier.size}`,
          nom,
          cheminRelatif: relatif,
          tailleOctets: Number(fichier.size || 0),
          dateModificationMs: Number(fichier.lastModified || 0),
          url,
        });
      }
    };
