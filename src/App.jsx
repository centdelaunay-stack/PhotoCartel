// PhotoCartel v44.4 — création automatique du dossier « Visites à rattacher » ; galerie v44.3 strictement inchangée.
...
const VERSION_PHOTOCARTEL = "v44.2";

const VERSION = {
  numero: VERSION_PHOTOCARTEL,
  descriptif: "Galerie d’une visite — reprise graphique locale",
  date: "2026-07-24",
  build: 2,
};
...
const validerNouvelleVisite = async () => {
  ...
  async function ouvrirGalerieVisiteMaquette(visite) {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE}/api/photos-visite?chemin=${encodeURIComponent(cheminVisite)}`
      );
      const data = await lireReponseJsonPhotoCartel(
        response,
    ...
    return (
      <header style={styles.galerieVisiteEntete}>
        ...
        <div style={styles.galerieVisiteEnteteTexte}>
          ...
          <div style={styles.galerieVisiteNom}>{visite.nom || "Visite sélectionnée"}</div>
          <div style={styles.galerieVisiteMeta}>
            {fichePhoto
              ? `${Math.min(indexPhotoGalerieVisite + 1, total)} / ${total}`
  ...
  function EcranGalerieVisiteMaquette() {
      ...
      return (
        <section style={styles.galerieVisiteEcran} aria-label="Fiche photo de la Galerie d’une visite">
          ...
          >
            ...
            <img
              src={urlPhotoGalerieVisite(photoActive)}
    ...
    return (
      <section style={styles.galerieVisiteEcran} aria-label="Page d’entrée de la Galerie d’une visite">
        ...
        {!chargementGalerieVisite && !erreurGalerieVisite && photosGalerieVisite.length > 0 && (
          <div style={styles.galerieVisiteGrille}>
            {photosGalerieVisite.map((photo, index) => (
              <button
              ...
              >
                <img
                  src={urlPhotoGalerieVisite(photo)}
                  alt=""
                  loading="lazy"
