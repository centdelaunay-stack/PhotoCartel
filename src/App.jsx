...
const VERSION = {
  numero: "v28.3",
  descriptif: "optimisation autorisations Android",
  date: "2026-07-08",
  build: 9,
};
...
// PhotoCartel v28.3 — optimisation des autorisations Android, moteur métier conservé.
...
const validerNouvelleVisite = async () => {
  ...
  try {
    ...
    setMessageArborescenceAndroid("Dossier visite créé sans validation finale : " + cheminVisiteFinal);
