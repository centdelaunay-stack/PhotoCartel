...
// PhotoCartel v34.6 — parcours d’autorisation Android sécurisé et persistance complète des analyses.
...
async function autoriserStockagePourAnalyseDepuisClic() {
  ...
  try {
    ...
    // Appel direct depuis le clic utilisateur : aucune opération asynchrone ne le précède.
    const dossierChoisi = await window.showDirectoryPicker({
      id: "photocartel-racine-v34-6",
      mode: "readwrite",
      startIn: "pictures",
    });
    ...
    if (dossierChoisi.name === "PhotoCartel") {
      ...
      throw new Error(
        "Mauvais dossier sélectionné. Sélectionne PhotoCartel dans DCIM, ou DCIM si PhotoCartel n’existe pas encore."
      );
    }
      ...
      {modeAutorisationStockageAnalyse && (
        <div style={styles.modalFond}>
          <div style={styles.modalCarte}>
            ...
            <p style={styles.modalTexte}>
              PhotoCartel doit accéder au dossier PhotoCartel pour enregistrer les photos à analyser et leurs résultats.
              Cet accès ne sera redemandé que s’il n’est plus disponible.
            </p>
            <button
              type="button"
            ...
            >
              {autorisationStockageAnalyseEnCours ? "Ouverture du dossier…" : "📁 Autoriser l’accès au dossier"}
            </button>
            <button
              type="button"
