// PhotoCartel v40.11 — collecte métier unifiée : prise de photo et rangement utilisent toujours la racine officielle PhotoCartel.
...
function App() {
  ...
  async function verifierServeurModificationVisite() {
    ...
    if (String(informations.version || "") !== "v40.11") {
      throw new Error(
        `Le serveur actif annonce ${informations.version || "une version inconnue"}, pas v40.11. ` +
...
const afficherMessageDiscretArborescence = (message, duree = 5000) => {
  ...
  function dossierRacineMetierEnvoyeAuServeur() {
    // v40.11 : les opérations métier de visite (collecte et rangement)
  ...
  async function rangerPhotosVisitesAndroid(visitesAtraiter) {
    // v40.11 : aucun fichier source n'est supprimé avant une vérification complète
    ...
    for (const item of fichiersACopier) {
      ...
      try {
        ...
        // v40.11 : certains fournisseurs de stockage Android renvoient une erreur
