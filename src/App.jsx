// PhotoCartel v40.12 — collecte métier unifiée : prise de photo et rangement utilisent toujours la racine officielle PhotoCartel.
...
function App() {
  ...
  async function verifierServeurModificationVisite() {
    ...
    if (String(informations.version || "") !== "v40.12") {
      throw new Error(
        `Le serveur actif annonce ${informations.version || "une version inconnue"}, pas v40.12. ` +
