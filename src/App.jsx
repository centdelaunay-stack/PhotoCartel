...
const VERSION = {
  numero: "v34.3",
  descriptif: "stabilisation de la persistance PWA",
  date: "2026-07-12",
  build: 3,
};
...
// PhotoCartel v34.3 — stabilisation de la persistance PWA et des autorisations de dossier.
...
async function handleAnalyserUnePhoto() {
  // v34.3 : sur Android/PWA, préparer l'accès au dossier PhotoCartel
  // depuis ce clic utilisateur avant d'ouvrir le choix caméra/galerie.
  fermerAnalysePhoto();
  ...
  if (estAndroid()) {
    try {
      ...
      window.alert(
        "PhotoCartel doit accéder au dossier PhotoCartel pour enregistrer les photos. " +
          error.message
      );
      return;
    }
