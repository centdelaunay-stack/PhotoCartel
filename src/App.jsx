...
// PhotoCartel v38.2 — la création d’une visite réactive directement l’autorisation du dossier racine PhotoCartel et ne réutilise plus un sous-dossier invalide.
...
async function obtenirDossierRacinePhotoCartelAndroid({
  ...
  // v38.2 : un nouvel identifiant de sélecteur neutralise l’ancien emplacement
...
async function creerDossiersNouvelleVisiteAndroid({ voyageNom, villeNom, visiteNom, typeVisiteNom }) {
  ...
  // v38.2 : cette fonction est appelée directement depuis le clic « Créer la visite ».
