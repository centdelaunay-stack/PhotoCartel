// PhotoCartel v41 — modification d’identité fiabilisée : erreur métier non rejouée sur une seconde route et serveur v41 obligatoire.
...
function App() {
  ...
  async function verifierServeurModificationVisite() {
    ...
    if (String(informations.version || "") !== "v41") {
      throw new Error(
        `Le serveur actif annonce ${informations.version || "une version inconnue"}, pas v41. ` +
  ...
  async function appelerModificationIdentiteVisite(payload) {
    ...
    // v41 : une erreur métier ne doit jamais provoquer un second envoi du même
