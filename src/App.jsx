// PhotoCartel v45.7.1 — polissage graphique du bloc supérieur et du menu Dernières visites.
...
const validerNouvelleVisite = async () => {
  ...
  const baseStyles = {
    ...
    dernieresVisitesOptionsDefilantes: {
      maxHeight: "min(400px, calc(100dvh - 285px))",
      overflowY: "auto",
  ...
  function InfoLigne({ icone, label, valeur, action }) {
    ...
    return (
      <div className="photocartel-ligne-etat" style={styles.ligneEtat}>
        ...
        <div style={{ minWidth: 0, textAlign: "left", display: "grid", gap: "2px" }}>
