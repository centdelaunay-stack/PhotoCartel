// PhotoCartel v28.3.1.1-suppression-popups-confirmation-succes — server cloud-ready. Base v21.1 conservée pour rangement photos sans doublons.
...
console.log("PhotoCartel v28.3.1.1-suppression-popups-confirmation-succes — routes Mode Démonstration actives");
...
app.get(["/health", "/api/health"], (req, res) => {
  res.json({
    ...
    version: "v28.3.1-suppression-popups-confirmation-succes",
...
// PhotoCartel v28.3.1.1-suppression-popups-confirmation-succes — routes Mode Démonstration déclarées très tôt.
