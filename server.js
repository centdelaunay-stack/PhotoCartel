// PhotoCartel v28.3-optimisation-autorisations-android — server cloud-ready. Base v21.1 conservée pour rangement photos sans doublons.
...
console.log("PhotoCartel v28.3-optimisation-autorisations-android — routes Mode Démonstration actives");
...
app.get(["/health", "/api/health"], (req, res) => {
  res.json({
    ...
    version: "v28.3-optimisation-autorisations-android",
...
// PhotoCartel v28.3-optimisation-autorisations-android — routes Mode Démonstration déclarées très tôt.
